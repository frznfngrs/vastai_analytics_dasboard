...
class Database:
    ...
    def insert_machine(self, time, data):
        ...
        query = "INSERT INTO machine (time, machine_id, account_credit, reliability, rentals_stored, rentals_on_demand, rentals_bid, earn_hour, hostname, earn_day, verification, end_date) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        values = (time, settings.VAST_MACHINE_ID, data['account_credit'], data['reliability'], data['rentals_stored'], data['rentals_on_demand'], data['rentals_bid'], data['earn_hour'], data['hostname'], data['earn_day'], data['verification'], data['end_date'])
        self.exec(query, values)
